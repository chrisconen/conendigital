...
<section id="blogWidget" style="border-top:1px solid rgba(255,255,255,.04);padding:4rem 0 3rem;background:rgba(0,0,0,.3);margin-top:3rem">
  <div style="max-width:1200px;margin:0 auto;padding:0 2rem">
    <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:2rem;flex-wrap:wrap;gap:1rem">
      ...
      <a href="/blog/" style="font-family:'JetBrains Mono',monospace;font-size:.72rem;letter-spacing:.1em;text-transform:uppercase;padding:.6rem 1.2rem;border:1px solid #C9A962;color:#C9A962;text-decoration:none;transition:all .3s">Összes cikk →</a>
    </div>
    <div style="display:grid;grid-template-columns:repeat(3,1fr);gap:1.5rem">
      ...
      <a href="${p.u}" style="background:rgba(255,255,255,.02);border:1px solid rgba(255,255,255,.05);padding:1.5rem;text-decoration:none;color:inherit;transition:all .35s;display:flex;flex-direction:column;gap:.75rem">
        <div style="font-family:'JetBrains Mono',monospace;font-size:.62rem;color:rgba(255,255,255,.35);text-transform:uppercase;letter-spacing:.1em;display:flex;gap:.5rem"><span style="color:#C9A962">${p.c}</span><span>·</span><span>${p.d}</span></div>
        <div style="font-size:1rem;font-weight:600;line-height:1.3">${p.t}</div>
        <div style="font-family:'JetBrains Mono',monospace;font-size:.65rem;color:#C9A962;margin-top:auto;letter-spacing:.08em">Olvasás →</div>
      </a>`).join('')}
    </div>
  </div>
</section>
